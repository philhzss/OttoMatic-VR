...
static const EffectDef kEffectsTable[] =
{
	...
	[EFFECT_PUNCHHIT_LEFT]         = {SOUNDBANK_MAIN   , "PunchHit"        , 1000, 0	},
	[EFFECT_PUNCHHIT_RIGHT]         = {SOUNDBANK_MAIN   , "PunchHit"        , 1000, 0	},
...
static const AutoRumbleDef kAutoRumbleTable[] =
{
	...
	[EFFECT_PUNCHHIT_RIGHT]   = {0.75f, .250, 200, vrRightVibrate}, // tweaked VR
	[EFFECT_PUNCHHIT_LEFT]    = {0.75f, .250, 200, vrLeftVibrate}, // tweaked VR
	...
	[EFFECT_POWPODHIT]        = {0.0f, 0.0f}, // but this should not play in VR when motion punching
	...
	[EFFECT_GIANTFOOTSTEP]    = {0.6f, .2, 60}, // tweaked VR
